...
<html lang="en">
  <head>
    ...
    <title>Disney Park | E-Locker</title>
          ...
          <div class="col-md-12">
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-search-box">
                ...
                <font color="RED"><span>${requestScope.elockerfail}</span></font>
                <font color="RED"><span>${requestScope.lockererror}</span></font>
              </div>
              <!-- / search box -->             
            </div>
          </div>
              ...
              <div class="row">
                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                  <div class="aa-product-view-content">
                    <h3 style="font-weight: bolder">Amusement park E-Lockers</h3>
                    <div class="aa-price-block">
                        <span class="aa-product-view-price" style="font-weight: bold" >Individual : $5  |  Family : $10  |  Re-use locker charges : $5</span><br/><br/>
                      
                    </div>
                    <form method="POST" action="lockerServlet">
                    ...
                    <div class="aa-prod-view-bottom">
                        <button class="aa-add-to-cart-btn" href>Reserve locker</button>
                      <a class="aa-add-to-cart-btn" href="reserveElocker.jsp">Re-use locker</a>
                    </div>
                    </form>    
                  </div>
                </div>
