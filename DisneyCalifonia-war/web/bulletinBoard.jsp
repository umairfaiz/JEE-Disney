<%-- 
    Document   : bulletingBoard
    Created on : Aug 30, 2017, 7:15:42 AM
    Author     : Umair
--%>
...
<html lang="en">
  <head>
    ...
    <title>Disney Park | Add Event</title>
          ...
          <div class="col-md-12">
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-search-box">
               <span>${requestScope.eventadded}</span>
               <span>${requestScope.eventaddedfail}</span>
               <span>${requestScope.eventdeleted}</span>
               <span>${requestScope.eventdeletedfail}</span>
              ...
              <div class="row">
                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                  <div class="aa-product-view-content">
                    <h3>Amusement park bulletin board manager</h3>
                    <form method="POST" action="bulletinServlet">
                    <div class="aa-prod-view-size">
                      Event ID: <input type="text" name="e_id" value="" /><br/><br/>
                      Event time:  <input type="text" name="e_time" placeholder="ex. 07:00 am "value="" /><br/><br/>
                      Event Name : <input type="text" name="e_name" value="" /><br/><br/>
                    </div>
