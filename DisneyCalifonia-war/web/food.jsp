<%-- 
    Document   : food
    Created on : Aug 31, 2017, 8:05:30 AM
    Author     : Umair
--%>
          ...
          <div class="col-md-12">
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-search-box">
                <font color="RED"><span>${requestScope.foodsucess}</span></font>
                <font color="RED"><span>${requestScope.foodfail}</span></font>
              </div>
              <!-- / search box -->             
            </div>
          </div>
              ...
              <ul class="aa-product-catg">
                ...
                <li>
                    ...
                    <figcaption>
                      ...
                      <input type="hidden" name="foodItem" value="Submarine" >
                      <span class="aa-product-price">$4.00</span>
                ...
                <li>
                    ...
                    <figcaption>
                      ...
                      <input type="hidden" name="foodItem" value="bucket">
                      <span class="aa-product-price">$5.00</span>
                ...
                <li>
                    ...
                    <figcaption>
                      ...
                      <input type="hidden" name="foodItem" value="cokacola" >
                      <span class="aa-product-price">$2.00</span>
