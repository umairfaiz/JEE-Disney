<%-- 
    Document   : account
    Created on : Aug 22, 2017, 11:54:52 AM
    Author     : Umair
--%>
...
<html lang="en">
  <head>
    ...
    <title>Disney Park | Account Page</title>
        ...
        <div class="aa-myaccount-area">         
            <div class="row">
              <div class="col-md-6">
                ...
                <h4>Login</h4>
                <c:set var="purchasestate" scope="request" value="${param.purchasestate}"/>
                    <c:if test="${purchasestate != null}">
                        <br/><font color="RED">Purchase was successful. Login with Wrist ID, Password : </font><span>${requestScope.wristID}</span>,<span>${requestScope.password}</span>
                    </c:if> 
                <c:set var="loginfail" scope="request" value="${param.loginfail}"/>
                    <c:if test="${loginfail != null}">
                        <br/><font color="RED">Login Failed. Try again : </font>
                    </c:if>
