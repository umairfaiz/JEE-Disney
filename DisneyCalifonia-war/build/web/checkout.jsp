<%-- 
    Document   : checkout
    Created on : Aug 31, 2017, 12:19:03 PM
    Author     : Umair
--%>
...
<html lang="en">
  <head>
    ...
    <title>Disney Park | Checkout</title>
              ...
              <div class="row">
                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                  <div class="aa-product-view-content">
                    <h3>Amusement Park Checkout Dashboard</h3>
                   ...
                   <c:forEach items="${wristList.rows}" var="i">    
                    ...
                    <div class="aa-prod-view-size">
                      Reloaded amount  <input type="text" name="reload" value="${i.CREDIT_LIMIT}" /><br/><br/>
                      Expenses : <input type="text" name="expenses" value="${i.EXPENCE}" /><br/><br/>
                    </div>
                    <div class="aa-prod-view-bottom">
                        <button class="aa-add-to-cart-btn" href>Checkout</button>
                      <a class="aa-add-to-cart-btn" href="index.jsp">Go back</a>
                    </div>
                    </form> 
                    </c:forEach>
                  </div>
