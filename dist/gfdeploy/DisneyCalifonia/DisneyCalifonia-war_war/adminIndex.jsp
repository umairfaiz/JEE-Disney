...
<html lang="en">
  <head>
    ...
    <title>Disney Park | Admin Home</title>
                ...
                <div class="aa-promo-left">
                  <div class="aa-promo-banner">                    
                    ...
                    <div class="aa-prom-content">
                      <h4><a href="ticketSales.jsp">Ticket Sales</a></h4>                      
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="aa-promo-right">
                  <div class="aa-single-promo-right">
                    <div class="aa-promo-banner">                      
                      ...
                      <div class="aa-prom-content">
                        <h4><a href="bulletinBoard.jsp">Manage Board</a></h4>                        
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="aa-single-promo-right">
                    <div class="aa-promo-banner">                      
                      ...
                      <div class="aa-prom-content">
                        <h4><a href="photos.jsp">PHOTO upload</a></h4>                        
                      </div>
                    </div>
                  </div>
                </div>
