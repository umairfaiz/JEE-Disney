<%-- 
    Document   : editbulletinBoard
    Created on : Sep 2, 2017, 9:35:56 PM
    Author     : Umair
--%>
...
<html lang="en">
  <head>
    ...
    <title>Disney Park | Edit Event</title>
          ...
          <div class="col-md-12">
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-search-box">
               <span>${requestScope.eventeditsuccess}</span>
               <span>${requestScope.eventeditfail}</span>
              </div>
              <!-- / search box -->             
            </div>
          </div>
