          ...
          <div class="col-md-12">
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-search-box">
                <font color="RED"><span>${requestScope.photosucess}</span></font>
                <font color="RED"><span>${requestScope.photofail}</span></font>
              </div>
              <!-- / search box -->             
            </div>
          </div>
          ...
          <div class="aa-product-catg-content">
            ...
            <div class="aa-product-catg-body">
              <ul class="aa-product-catg">
                ...
                <li>
                    <form action="purchase_photoServlet" method ="POST">  
                  <figure>
